...
namespace TileGame
{
    ...
    public class PlaySceneCamController : MonoBehaviour
    {
        ...
        private GameObject ContentWindowSpells;
        ...
        private void GetObjectReferances()
        {
            try
            {
                ...
                ContentWindowSpells = transform.Find("Canvas").Find("Panel").Find("SpellPanel").Find("Viewport").Find("SpellContent").gameObject;
                ...
                SpellPanel = transform.Find("Canvas").Find("Panel").Find("SpellPanel").gameObject;
        ...
        public void CastSpellButtonClicked()
        {
            try
            {
        ...
        private void AddSpellsToSpellContent()
        {
            try
            {
                ...
                {
                    GameObject tempbutton = Instantiate(BuildingButtonPrefab, ContentWindowSpells.transform); //create button and set its parent to content
                    tempbutton.name = kvp.Value.Title; //change name
                    tempbutton.transform.GetChild(0).GetComponent<Text>().text = kvp.Value.Title + System.Environment.NewLine + kvp.Value.Cost; //change text on button to match sprite and create new line and add cost
                    tempbutton.GetComponent<Image>().sprite = kvp.Value.Sprite; //set sprite
                    tempbutton.GetComponent<Button>().onClick.AddListener(CastSpellController); //adds method to button clicked 
                    tempbutton.AddComponent<ButtonProperties>();
        ...
        public void CastSpellController()
        {
            try
            {
